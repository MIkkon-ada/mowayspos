...
STATUS_COORDINATING = "待协调"
STATUS_PENDING_DECISION = "待决策"
STATUS_PENDING_OWNER_CONFIRM = "待负责人确认"
STATUS_RESOLVED = "已解决"
STATUS_CLOSED = "已关闭"

# 看板列顺序（前端 KANBAN_COLUMNS 对齐）
ALL_STATUSES = [
    STATUS_PENDING,
    STATUS_IN_PROGRESS,
    STATUS_COORDINATING,
    STATUS_PENDING_DECISION,
    STATUS_PENDING_OWNER_CONFIRM,
    STATUS_RESOLVED,
    STATUS_CLOSED,
]

# 待负责人确认：映射到看板"处理中"列（不新增看板列，用 badge 区分）
KANBAN_STATUS_ALIASES: dict[str, str] = {
    STATUS_PENDING_OWNER_CONFIRM: STATUS_IN_PROGRESS,
}
...
_STATUS_MAP: dict[str, str] = {
    ...
    "待处理": STATUS_PENDING,
    "待协调": STATUS_COORDINATING,
    "协调": STATUS_COORDINATING,
}
