...
from . import (
    ...
    project_init_ai_response as _response,
...
for _module in (_contracts, _normalization, _response, _spreadsheet, _pipeline):
...
def __getattr__(name: str):
    for module in (_contracts, _normalization, _response, _spreadsheet, _pipeline):
        try:
