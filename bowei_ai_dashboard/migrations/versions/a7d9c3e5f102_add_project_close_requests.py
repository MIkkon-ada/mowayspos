...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("unfinished_items_json", sa.Text(), nullable=False, server_default="[]"),
        sa.Column("remaining_risks_json", sa.Text(), nullable=False, server_default="[]"),
        ...
        sa.Column("review_comment", sa.Text(), nullable=True, server_default=""),
