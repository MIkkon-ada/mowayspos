...
# This launcher is exclusively for the local Vite instance on port 6003.
os.environ["FRONTEND_ORIGIN"] = "http://127.0.0.1:6003"
...
os.environ["CORS_ALLOWED_ORIGINS"] = (
    "http://127.0.0.1:6002,http://localhost:6002,"
    "http://127.0.0.1:6003,http://localhost:6003,"
