...
- [ ] **Step 1: Add a source-boundary test and direct compatibility behavior tests.**
...
- [ ] **Step 1: Refactor the strict service around a neutral role resolution.**
...
- [ ] **Step 2: Add compatibility-owned read helpers.**
...
- [ ] **Step 3: Run service and compatibility tests.**
...
- [ ] **Step 4: Commit the API containment.**
...
- [ ] **Step 1: Replace the project list and four legacy view call sites.**
...
- [ ] **Step 2: Record exact totals in this plan and commit.**
