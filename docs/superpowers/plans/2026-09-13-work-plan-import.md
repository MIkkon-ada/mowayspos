...
- [x] **Step 1: Define the expected normalized row contract in the test.**
...
- [x] **Step 2: Add the legacy-format compatibility test.**
...
- [x] **Step 3: Add invalid-row tests.**
...
- [x] **Step 4: Run the tests and verify they fail for the missing module.**
...
- [x] **Step 1: Implement header aliases and normalized types.**
...
- [x] **Step 2: Implement row parsing with carry-forward values.**
...
- [x] **Step 3: Run the parser tests and verify they pass.**
...
- [x] **Step 1: Replace the page-local parser and row type.**
...
- [x] **Step 2: Expand the preview state.**
...
- [x] **Step 3: Add the UI contract assertions.**
...
- [x] **Step 4: Run the frontend unit and contract tests.**
...
- [x] **Step 1: Write the complete-format payload test.**
...
- [x] **Step 2: Write the duplicate and atomicity tests.**
...
- [x] **Step 3: Run the new backend tests and verify they fail.**
...
- [x] **Step 1: Add the normalized backend row fields.**
...
- [x] **Step 2: Create a focused import service.**
...
- [x] **Step 3: Keep the router as an authorization boundary.**
...
- [x] **Step 3: Run a real exported-table simulation in an isolated test database.**
...
- [x] **Step 5: Run the relevant regression suite and inspect the diff.**
