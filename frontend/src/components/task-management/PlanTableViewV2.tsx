...
function statusClass(tone: PlanTableRow['statusTone']): string {
  const map: Record<string, string> = {
    neutral: 'v2-status--neutral', blue: 'v2-status--blue', green: 'v2-status--green', red: 'v2-status--red', amber: 'v2-status--amber',
  }
