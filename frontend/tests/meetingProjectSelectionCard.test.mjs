...
test('meeting project selector renders square project information cards', () => {
  ...
  assert.match(source, /project-card-period flex items-center/)
  assert.match(source, /project-card-manager flex items-center/)
  assert.match(source, /project-card-members flex items-center/)
  assert.match(source, /project-card-progress flex items-center/)
